...
public class MainMenu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Register titleUser = new Register();  JUser.setText(titleUser.Usuario);
        JUser.setBackground(new java.awt.Color(65, 201, 197));
        JUser.setFont(new java.awt.Font("Montserrat Alternates SemiBold", 0, 30)); // NOI18N
        JUser.setForeground(new java.awt.Color(255, 255, 255));
        JUser.setToolTipText("");
        JUser.setBorder(null);
        JUser.setOpaque(true);
        jPanel1.add(JUser);
        JUser.setBounds(140, 40, 130, 40);
        jPanel1.add(BtnMenu);
